...
namespace Hfs.Client
{
    ...
    public class MimeHelper
    {
        ...
        /// <summary>
        /// Ritorna mime da nome file
        /// </summary>
        /// <param name="file"></param>
        /// <returns></returns>
        public static string GetMimeFromFilename(string file)
        {
            return GetMimeFromExtension(System.IO.Path.GetExtension(file));
        }
        ...
        public static string GetMimeFromExtension(string ext)
        {
            ...
            if (!_MimeTypes.TryGetValue(ext.TrimStart('.').ToLower(), out sMime))
                sMime = _MimeTypes[@"bin"];
