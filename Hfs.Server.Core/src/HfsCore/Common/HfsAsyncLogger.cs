...
namespace Hfs.Server.CODICE.CLASSI
{
    ...
    /// Logger asincrono
    /// </summary>
    public class HfsAsyncLogger: IDisposable
    {
        ...
        public void WriteMessage(ELogType type, string text)
        {
        ...
        public void Start()
        {
            ...
            this.mTimer = new Timer((s) => flushLogs(false),
                                            null,
                                            TimeSpan.FromSeconds(15000),
                                            TimeSpan.FromSeconds(15000));
        }
