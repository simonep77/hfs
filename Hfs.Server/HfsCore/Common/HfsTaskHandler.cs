...
namespace Hfs.Server.CODICE.CLASSI
{
    public class HfsTaskHandler
    {
        ...
        private static void handleTempFiles(object arg)
        {
            ...
            DateTime dtExpired = new DateTime(dtNow.Year, dtNow.Month, dtNow.Day, 23, 59, 59).AddDays(-Hfs.Server.Properties.Settings.Default.TempFilesKeepDays);
        ...
        private static void handleLogFiles(object arg)
        {
            ...
            //Pulisce
            DateTime dtNow = DateTime.Now;
            DateTime dtExpired = new DateTime(dtNow.Year, dtNow.Month, dtNow.Day, 23, 59, 59).AddDays(-Hfs.Server.Properties.Settings.Default.LogKeepDays);
